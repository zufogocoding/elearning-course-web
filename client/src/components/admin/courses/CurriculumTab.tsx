...
// Shared types
import { Option, Question, Quiz, Lesson, Section } from "@/app/admin/courses/[id]/builder/types";

// Sub-components
import SaveStatus, { SaveState } from "@/app/admin/courses/[id]/builder/components/SaveStatus";
import CurriculumSidebar, { DraggedItemData, DropTargetData } from "@/app/admin/courses/[id]/builder/components/CurriculumSidebar";
import LessonEditor from "@/app/admin/courses/[id]/builder/components/LessonEditor";
import QuizEditor from "@/app/admin/courses/[id]/builder/components/QuizEditor";

export default function CurriculumTab({ courseId }: { courseId: number }) { params }: { params: Promise<{ id: string }> }) {
