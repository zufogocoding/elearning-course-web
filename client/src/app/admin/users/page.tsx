...
const INITIAL_USERS: AppUser[] = [
  {
    id: "u1", name: "Alice Wang", email: "alice.wang@email.com", joined: "Jan 5, 2024",
    courses: 4, status: "Active", role: "User", color: "from-violet-500 to-indigo-600",
    bio: "UX designer passionate about clean interfaces.", totalSpent: "$254.97", lastActive: "2h ago",
    enrolledCourses: [{ title: "UI/UX Design Masterclass", progress: 82 }, { title: "Advanced React Patterns", progress: 45 }],
    purchases: [{ date: "Jan 15", course: "UI/UX Design Masterclass", amount: "$89.99" }],
  },
  {
    id: "u2", name: "Brian Torres", email: "brian.t@email.com", joined: "Jan 18, 2024",
    courses: 3, status: "Active", role: "User", color: "from-cyan-500 to-blue-600",
    bio: "Full-stack developer exploring new technologies.", totalSpent: "$194.97", lastActive: "1d ago",
    enrolledCourses: [{ title: "Advanced React Patterns", progress: 60 }],
    purchases: [{ date: "Jan 18", course: "Advanced React Patterns", amount: "$74.99" }],
  },
  {
    id: "u3", name: "Clara Singh", email: "clara.s@email.com", joined: "Feb 2, 2024",
    courses: 2, status: "Active", role: "User", color: "from-emerald-500 to-teal-600",
    bio: "Marketing specialist building brand strategies.", totalSpent: "$119.98", lastActive: "3d ago",
    enrolledCourses: [{ title: "Digital Marketing Strategy", progress: 100 }],
    purchases: [{ date: "Feb 2", course: "Digital Marketing Strategy", amount: "$59.99" }],
  },
  {
    id: "u4", name: "David Kim", email: "david.kim@email.com", joined: "Feb 14, 2024",
    courses: 5, status: "Active", role: "Admin", color: "from-amber-500 to-orange-600",
    bio: "Data scientist and AI enthusiast.", totalSpent: "$419.95", lastActive: "Just now",
    enrolledCourses: [{ title: "Python for Data Science", progress: 90 }, { title: "Intro to AI & ML", progress: 55 }],
    purchases: [{ date: "Feb 14", course: "Python for Data Science", amount: "$99.99" }],
  },
  {
    id: "u5", name: "Emma Davis", email: "emma.davis@email.com", joined: "Mar 1, 2024",
    courses: 1, status: "Banned", role: "User", color: "from-rose-500 to-pink-600",
    bio: "Graphic designer and creative professional.", totalSpent: "$49.99", lastActive: "2w ago",
    enrolledCourses: [{ title: "Graphic Design Fundamentals", progress: 30 }],
    purchases: [{ date: "Mar 1", course: "Graphic Design Fundamentals", amount: "$49.99" }],
  },
  {
    id: "u6", name: "Felix Müller", email: "felix.m@email.com", joined: "Mar 10, 2024",
    courses: 2, status: "Active", role: "User", color: "from-indigo-500 to-purple-600",
    bio: "Entrepreneur exploring digital marketing.", totalSpent: "$134.98", lastActive: "5h ago",
    enrolledCourses: [{ title: "Digital Marketing Strategy", progress: 50 }],
    purchases: [{ date: "Mar 10", course: "Digital Marketing Strategy", amount: "$59.99" }],
  },
  {
    id: "u7", name: "Grace Park", email: "grace.park@email.com", joined: "Apr 3, 2024",
    courses: 3, status: "Active", role: "User", color: "from-teal-500 to-cyan-600",
    bio: "Product manager focused on user-centric design.", totalSpent: "$264.97", lastActive: "Yesterday",
    enrolledCourses: [{ title: "UI/UX Design Masterclass", progress: 25 }],
    purchases: [{ date: "Apr 3", course: "UI/UX Design Masterclass", amount: "$89.99" }],
  },
  {
    id: "u8", name: "Hassan Omar", email: "hassan.o@email.com", joined: "Apr 22, 2024",
    courses: 0, status: "Banned", role: "User", color: "from-slate-500 to-gray-600",
    bio: "Suspended for violating terms of service.", totalSpent: "$0.00", lastActive: "1mo ago",
    enrolledCourses: [],
    purchases: [],
  },
];
  ...
  const toggleBan = (id: string) => {
    ...
    if (selectedUser?.id === id) {
      setSelectedUser((prev) =>
        prev ? { ...prev, status: prev.status === "Active" ? "Banned" : "Active" } : null
      );
    }
  };
